          ...
          case "Bomb":
            if (
              gameHandler.activeBombs.filter(
                b => gameHandler.players[0].id == b.ownerId
              ).length < gameHandler.players[0].stats.bCount
            ) {
              const bmb = gameHandler.players[0].layBomb();
              ...
              setTimeout(() => {
                ...
                Explode(gameHandler.players[0].stats.range);
